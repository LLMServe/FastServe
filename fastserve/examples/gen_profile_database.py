...
from fastserve.llm import OfflineLLM
from fastserve import SamplingParams
from fastserve.profiling import (
    ProfilingDatabase,
    ProfilingResult,
    ParallelConfig,
    PromptConfig,
)
from fastserve.profiling import bs_config, in_len_config
...
def main(args, llm):
    ...
    for idx, input_len in enumerate(in_len_config):
        ...
        for idy, batch_size in enumerate(bs_config):
            if input_len*batch_size > args.max_num_tokens:
                continue
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max-num-tokens", type=int, default=100000000000000)
