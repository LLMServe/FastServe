...
class BatchedRequests:
    ...
    def sort_requests_context_first(self) -> None:
        # sort the requests by context stage first
        self.requests = [req for req in self.requests if req.is_context_stage()] + [req for req in self.requests if not req.is_context_stage()]
