...
num_prompt_list=(400 600 660 700 760 800 1000 1000 1200 1400 1600 1800 2000 2200 3000)
rate_list=(2 3 3.3 3.5 3.8 4 5 5.5 6 7 8 9 10 11 12)
...
for (( i=0; i<num_tests; i++ )); do
    ...
    python3 fastserve/api_server/fastserve_api_server.py \
        ...
        --use-skip-join \
        --profiling-file /users/lsy/research/FastServe/profiling-model &
