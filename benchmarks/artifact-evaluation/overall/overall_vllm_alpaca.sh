...
num_prompt_list=(100 300 300 300 300 300 300 300 300 300 340 400)
rate_list=(1 3 5 8 11 11.5 12 13 14 15 17 20)
num_tests=${#rate_list[@]}
...
for (( i=0; i<num_tests; i++ )); do
    ...
    LOG_FILE="${LOG_DIR}/exp-vllm-${DATASET_NAME}-${num_prompt}-${rate}-client-log"
