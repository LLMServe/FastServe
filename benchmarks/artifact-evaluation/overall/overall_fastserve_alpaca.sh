...
num_prompt_list=(100 300 300 300 300 300 300 300 300 300 340 400 600 800)
rate_list=(1 3 5 8 11 11.5 12 13 14 15 17 20 30 40)
...
for (( i=0; i<num_tests; i++ )); do
    ...
    LOG_FILE="${LOG_DIR}/exp-fastserve-${DATASET_NAME}-${num_prompt}-${rate}-client-log"
    ...
    python3 fastserve/api_server/fastserve_api_server.py \
        ...
        --use-skip-join \
        --profiling-file ./profiling-model > /users/zzl/FastServe/benchmarks/artifact-evaluation/overall/server.log 2>&1 &
