...
xs = [
    ...
    [
        # vLLM
        read_result_series("logs", "exp-vllm-sharegpt", "bs=128-client-log")[0],
        # FastGen-FCFS
        read_result_series("logs", "exp-fcfs-sharegpt", "bs=128-client-log")[0],
        # FastGen
        read_result_series("logs", "exp-fastserve-sharegpt", "bs=128-client-log")[0],
    ],
]
ys = [
    # Figure 1
    [
        # vLLM
        read_result_series("logs", "exp-vllm-sharegpt", "bs=128-client-log")[1],
        # FastGen-FCFS
        read_result_series("logs", "exp-fcfs-sharegpt", "bs=128-client-log")[1],
        # FastGen
        read_result_series("logs", "exp-fastserve-sharegpt", "bs=128-client-log")[1],
    ],
]
y_limits = [0.2, 0.5]
...
for j in range(num_subfigs):
    ...
    # Plot grid
fig.text(0.5, -0.27, 'BS=128.', fontsize=17, fontname='Times New Roman', 
